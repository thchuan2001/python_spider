...
class mySpider(scrapy.spiders.Spider):
    ...
    with open("./date.txt","r") as f:
        date=f.read()
    start_urls=["https://ourworldindata.org/explorers/coronavirus-data-explorer?tab=table&zoomToSelection=true&time=2021-12-{}&facet=none&uniformYAxis=0&pickerSort=asc&pickerMetric=total_cases&Metric=Confirmed+deaths&Interval=Cumulative&Relative+to+Population=false&Color+by+test+positivity=false".format(date)]
